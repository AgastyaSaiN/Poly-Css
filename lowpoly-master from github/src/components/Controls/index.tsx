...
const Controls: FC<{
  ...
  outputJson: string;
  open: any;
}> = ({ className, output, outputJson, open }) => {
    ...
    <Container className={className}>
      ...
      <StyledControls open={open}>
        ...
        <ControlGroup title="Export">
          ...
          <DownloadButton href={jsonUrl} download="lowpoly.json">
            Download JSON
          </DownloadButton>
          <FileMetadata>
            {getJsonSize()} &bull; {settings.dimensions.width} &times;
            {settings.dimensions.height}
          </FileMetadata>
        </ControlGroup>
        ...
        <Footer>
          ...
          <a href="https://github.com/AgastyaSaiN" target="_blank">
            Agastya
          </a>
        </Footer>
      </StyledControls>
